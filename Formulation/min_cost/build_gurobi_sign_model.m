function [nodelist,node_montype_map] = build_gurobi_sign_model(em_file,coverage_file,cost_file,mon_type_file,path_num,node_num,mon_type_num)
    ...
    for t = 1:mon_type_num
        ...
        for i = 0:path_num - 1
            ...
            if ismember(x_i,nodelist)  
                ...
                coe_int = int64(coe);
                fprintf(c_file,' %d x', coe);
                fprintf(c_file,'%d',x_i);
                flag = 1;
                flag_s = 1;
            end
        end

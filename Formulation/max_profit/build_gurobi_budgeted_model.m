function [nodelist,node_montype_map] = build_gurobi_budgeted_model(em_file,coverage_file,cost_file,path_weight_file,mon_type_file,accuracy_file,tgroup_file,path_num,node_num,mon_type_num,budget)

...
namespace NesCheck
{
	...
	public:
		...
		// AnalysisState(AnalysisState &&) = delete;
		// AnalysisState &operator=(const AnalysisState &) = delete;
		// AnalysisState &operator=(AnalysisState &&) = delete;
		static AnalysisState &getInstance()
		{
			static AnalysisState astate{};
			return astate;
		}

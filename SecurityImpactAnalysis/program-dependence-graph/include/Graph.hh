...
namespace pdg
{
  ...
  public:
    ...
    typedef std::set<llvm::AllocaInst *> StackObjectsSet;
    ...
    // OptiSan - To deal with aliases to stack data (Efficiency)
    bool isIndirectUse(pdg::Node &src, pdg::Node &dst);
    void addAddressTakenStackObject(llvm::AllocaInst *AI)
    {
      if (AI)
        addressTakenStackObjects.insert(AI);
    }

    StackObjectsSet getAddressTakenStackObjects()
    {
      return addressTakenStackObjects;
    }
  ...
  private:
    ...
    // OptiSan
    StackObjectsSet addressTakenStackObjects;
  };
} // namespace pdg

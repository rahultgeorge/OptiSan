...
// Canary circumvention not used
// #define CANARY_DATA_EDGE_LABEL "New data edge(UPA_CANARY)"
...
// New state type for an modified pointer on the stack (that is can be modified/overwritten)
#define IMPACTED_STACK_POINTER "4"
// New state type for modified data object on the stack
...
// Actions related to stack data which can be leaked
#define LEAKED_OBJECT_LOCAL_ACTION_TYPE "12"
// Actions related to stack data which can be leaked
#define LEAKED_OBJECT_NON_LOCAL_ACTION_TYPE "13"
